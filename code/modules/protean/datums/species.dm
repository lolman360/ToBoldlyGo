/datum/appearance_descriptor/age/protean
	chargen_min_index = 1
	chargen_max_index = 4
	standalone_value_descriptors = list( //placeholder values, need lore
		"brand new" =            1,
		"worn" =                 5,
		"an older model" =      12,
...
/decl/species/protean
	name =                  SPECIES_PROTEAN
	name_plural =           "Nanomorphs"
	description =           "Nanomachines, son. Motile and self-directed or whatever. Need lore to put in here."
	cyborg_noun = null
	...
	passive_temp_gain =     0  // stabilize at ~80 C in a 20 C environment.
